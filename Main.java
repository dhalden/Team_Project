...
public class Main {
	public static void main(String[] args){
		...
		Factory f1 = new Factory(clock, inv, 20);
		Factory f2 = new Factory(clock, inv, 30);
		Factory f3 = new Factory(clock, inv, 40);
		Factory f4 = new Factory(clock, inv, 50);
		Factory f5 = new Factory(clock, inv, 60);
